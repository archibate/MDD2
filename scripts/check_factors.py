...
print(diff.round(2)[['ts_code', 'timestamp', 'time'] + [c for c in factors.columns if 'momentum_o_0o1' in c]])
print(diff.round(2)[['ts_code', 'timestamp', 'time'] + [c for c in factors.columns if 'momentum_h_0o1' in c]])
