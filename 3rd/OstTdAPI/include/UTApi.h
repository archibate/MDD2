...
public:
	...
	///请求查询收益互换合约响应
	virtual void OnRspQryDMAInstrument(CUTDMAInstrumentField *pDMAInstrument, CUTRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};
...
public:
	...
	///请求查询收益互换合约
	virtual int ReqQryDMAInstrument(CUTQryDMAInstrumentField *pQryDMAInstrument, int nRequestID) = 0;
