...
struct CUTInvestorField
{
	...
	///主席客户代码
	TUTMainSeatClientIDType	MainSeatClientID;
};
///期权手续费率
...
struct CUTSyncInvestorPositionField
{
	...
	TUTLargeVolumeType	YdPosition;
	///持仓调整类型
	TUTSynPosiTypeType	SynPosiType;
	///开仓成本变化
	TUTMoneyType	OpenCost;
};
///手工出入金
...
struct CUTOrderField
{
	...
	///席位安装编号
	TUTTraderInstallIDType	TraderInstallID;
	///今成交数量
...
struct CUTDMAInstrumentField
{
	...
	TUTLargeVolumeType	Volume;
	///数量冻结
	TUTLargeVolumeType	VolumeFrozen;
};
///交易所返回报单补充
struct CUTExchangeOrderAdditionField
{
	///投资者代码
	TUTInvestorIDType	InvestorID;
	///合约代码
...
///SyncMDB
struct CUTSyncMDBField
{
	///个数
	TUTNoGroupsType	NoGroups;
};
///Sql文本
struct CUTSqlTextField
{
	///Sql文本
	TUTSqlTextType	SqlText;
};
///Dll设置
...
///收益互换合约查询
struct CUTQryDMAInstrumentField
{
	///交易所代码
	TUTExchangeIDType	ExchangeID;
	///合约代码
