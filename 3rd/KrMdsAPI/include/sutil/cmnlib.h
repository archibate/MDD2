 ...
 */
#undef  SPK_BITS_CLR
#undef  SPK_BITS_CLR32
#undef  SPK_BITS_CLR64
#undef  SPK_BITS_CLR_DIRECT
#undef  SPK_BITS_CLR_DIRECT32
#undef  SPK_BITS_CLR_DIRECT64

#define SPK_BITS_CLR(x, f)              ( (x) & ~(f) )
#define SPK_BITS_CLR32(x, f)            ( (x) & ~((uint32) f) )
#define SPK_BITS_CLR64(x, f)            ( (x) & ~((uint64) f) )

#define SPK_BITS_CLR_DIRECT(x, f)       ( (x) &= ~(f) )
#define SPK_BITS_CLR_DIRECT32(x, f)     ( (x) &= ~((uint32) f) )
#define SPK_BITS_CLR_DIRECT64(x, f)     ( (x) &= ~((uint64) f) )
...
#define SPK_BITS_CLR_U32                SPK_BITS_CLR32
#define SPK_BITS_CLR_U64                SPK_BITS_CLR64
#define SPK_BITS_CLR_DIRECT_U32         SPK_BITS_CLR_DIRECT32
#define SPK_BITS_CLR_DIRECT_U64         SPK_BITS_CLR_DIRECT64
/* -------------------------           */
...
#undef  SPK_BITS_ISSET_N32
#undef  SPK_BITS_ISSET_N64

#define SPK_BITS_ISSET_N(x, n)          SPK_BITS_ISSET_N64(x, n)
#define SPK_BITS_ISSET_N32(x, n)        ( ((x) & (1U   << (n))) > 0 )
#define SPK_BITS_ISSET_N64(x, n)        ( ((x) & (1ULL << (n))) > 0 )

/*
 * 设置相应位
 */
#undef  SPK_BITS_SET_N
#undef  SPK_BITS_SET_N32
#undef  SPK_BITS_SET_N64
#undef  SPK_BITS_SET_N_DIRECT
#undef  SPK_BITS_SET_N32_DIRECT
#undef  SPK_BITS_SET_N64_DIRECT

#define SPK_BITS_SET_N(x, n)            SPK_BITS_SET_N64(x, n)
#define SPK_BITS_SET_N32(x, n)          ( (x) | (1U   << (n)) )
#define SPK_BITS_SET_N64(x, n)          ( (x) | (1ULL << (n)) )

#define SPK_BITS_SET_N_DIRECT(x, n)     SPK_BITS_SET_N64_DIRECT(x, n)
#define SPK_BITS_SET_N32_DIRECT(x, n)   ( (x) |= (1U   << (n)) )
#define SPK_BITS_SET_N64_DIRECT(x, n)   ( (x) |= (1ULL << (n)) )

/*
 * 清除相应位
 */
#undef  SPK_BITS_CLR_N
#undef  SPK_BITS_CLR_N32
#undef  SPK_BITS_CLR_N64
#undef  SPK_BITS_CLR_N_DIRECT
#undef  SPK_BITS_CLR_N32_DIRECT
#undef  SPK_BITS_CLR_N64_DIRECT

#define SPK_BITS_CLR_N(x, n)            SPK_BITS_CLR_N64(x, n)
#define SPK_BITS_CLR_N32(x, n)          ( (x) & ~(1U   << (n)) )
#define SPK_BITS_CLR_N64(x, n)          ( (x) & ~(1ULL << (n)) )

#define SPK_BITS_CLR_N_DIRECT(x, n)     SPK_BITS_CLR_N64_DIRECT(x, n)
#define SPK_BITS_CLR_N32_DIRECT(x, n)   ( (x) &= ~(1U   << (n)) )
#define SPK_BITS_CLR_N64_DIRECT(x, n)   ( (x) &= ~(1ULL << (n)) )
/* -------------------------           */
