 ...
 *          - 同步OES的通用错误码定义
 *              - 1044, 数据无变化 (MDSERR_DATA_UNCHANGED)
 *              - 1045, 无效的登录用户名称或密码 (MDSERR_INVALID_USERNAME_OR_PASSWORD)
 *              - 1046, 密码已被锁定 (MDSERR_PASSWORD_LOCKED)
 *
 * @since   2016/1/3
 */
...
/** 1044, 数据无变化 */
#define MDSERR_DATA_UNCHANGED                   (&__ERRS_mdsApiErrors[43])
/** 1045, 无效的登录用户名称或密码 */
#define MDSERR_INVALID_USERNAME_OR_PASSWORD     (&__ERRS_mdsApiErrors[44])
/** 1046, 密码已被锁定 */
#define MDSERR_PASSWORD_LOCKED                  (&__ERRS_mdsApiErrors[45])
/* -------------------------           */
