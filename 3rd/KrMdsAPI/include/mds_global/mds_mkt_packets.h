 ...
 *          - 将上交所Level-2快照行情的增量更新消息标识为已废弃 (上交所行情快照发送机制调整后, 不再推送增量更新消息)
 *          - 调整逐笔数据重建标识(tickRebuildFlag)的含义, 补充和重复的逐笔数据相关的内容:
...
/** 当前采用的协议版本号 */
#define MDS_APPL_VER_ID                         "0.17.6.17"
 ...
 */
#define MDS_APPL_VER_VALUE                      1001706171
